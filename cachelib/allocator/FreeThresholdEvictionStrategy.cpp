...
FreeThresholdEvictionStrategy::FreeThresholdEvictionStrategy(double freeThreshold)
    : freeThreshold_(freeThreshold) {}

size_t FreeThresholdEvictionStrategy::calculateBatchSize(const CacheBase& cache,
                                                        unsigned int tid,
                                                        PoolId pid,
                                                        ClassId cid ) {
